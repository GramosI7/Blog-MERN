...
restRouter.use("/article", _article.articleRouter);
...
articleRouter.route("/").post(_passport2.default.authenticate("jwt", { session: false }), _article2.default.create).get(_article2.default.findAll);

articleRouter.route("/:id").get(_article2.default.findOne).put(_passport2.default.authenticate("jwt", { session: false }), _article2.default.update).delete(_passport2.default.authenticate("jwt", { session: false }), _article2.default.delete);
...
exports.default = {
  create: function create(req, res) {
    ...
    return _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
      var _ArticleService$valid, value, error, article;
      ...
      return _regenerator2.default.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _ArticleService$valid = _article4.default.validateBody(req.body), value = _ArticleService$valid.value, error = _ArticleService$valid.error;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 3:
              ...
              return _context2.abrupt("return", res.status(404).json({ err: 'could not find the article' }));

            case 6:
              return _context2.abrupt("return", res.json(article));
  ...
  update: function update(req, res) {
    ...
    return _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee4() {
      var id, _ArticleService$valid2, value, error, article;
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              _context4.prev = 0;
              id = req.params.id;
              _ArticleService$valid2 = _article4.default.validateBody(req.body), value = _ArticleService$valid2.value, error = _ArticleService$valid2.error;
...
var _isEmpty = __webpack_require__(6);
            ...
            case 4:
              ...
              _profil2.default.findOne({ user: req.user.id }).then(function (profil) {
                if (profil) {
                  ...
                  _profil2.default.findOne({ handle: profileFields.handle }).then(function (profil) {
                    if (profil) {
...
exports.default = {
    validateProfileInput: function validateProfileInput(data) {
        ...
        if (_validator2.default.isEmpty(data.website)) {
            errors.website = 'Profile website is required';
        }
        if (_validator2.default.isEmpty(data.location)) {
        ...
        if (_validator2.default.isEmpty(data.bio)) {
